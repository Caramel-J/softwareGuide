...
新老产品注册证交替时，如有老注册证的产品出入库，则需要在首营品种里添加老注册证信息。
...
添加产品的通用价格，选择类型以便固定采购或销售产品的价格，不需要重复输入价格，如 [图1 - 3 - 1](/baseBusiness/1.8.png) 所示。

<div class="fy-show-img">
    <img src="/baseBusiness/1.8.png" alt="产品信息-添加价格" />
    <span>图 1-3-1</span>
</div>
